package com.example.application.views.quotes;
...
@Uses(Icon.class)
public class QuotesView extends Div implements BeforeEnterObserver {
    ...
    public QuotesView(SamplePersonService samplePersonService) {
        this.samplePersonService = samplePersonService;
        addClassNames("quotes-view");
        ...
        grid.asSingleSelect().addValueChangeListener(event -> {
            if (event.getValue() != null) {
                ...
                clearForm();
                UI.getCurrent().navigate(QuotesView.class);
            }
        });
    ...
    public void beforeEnter(BeforeEnterEvent event) {
        ...
        if (samplePersonId.isPresent()) {
            ...
            if (samplePersonFromBackend.isPresent()) {
                ...
                // refresh grid
                refreshGrid();
                event.forwardTo(QuotesView.class);
            }
        }
    }
